...
# # Shift landing point to nearest safe pixel if original is unsafe
# if cost[landing_row, landing_col] >= SAFE_COST_THRESHOLD:
#     print("Landing point unsafe, shifting to nearest safe pixel...")
...
#                     if cost[rr, cc] < SAFE_COST_THRESHOLD:
#                         landing_row, landing_col = rr, cc
#                         found = True
#                         break
#             if found:
#                 break
